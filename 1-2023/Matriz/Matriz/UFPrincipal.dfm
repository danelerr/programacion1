object frmPrincipal: TfrmPrincipal
  ...
  object Button1: TButton
    ...
    Width = 153
    Height = 31
    Caption = 'Numero mayor de la matriz'
    TabOrder = 3
  ...
  object MainMenu1: TMainMenu
    ...
    object Metodos1: TMenuItem
      ...
      object devolvermenorbinarioendecima1: TMenuItem
        Caption = 'devolver menor binario en decima'
        OnClick = devolvermenorbinarioendecima1Click
      end
    ...
    object Matrizchar1: TMenuItem
      ...
      object Buscarcadena1: TMenuItem
        Caption = 'Buscar cadena'
        OnClick = Buscarcadena1Click
      end
    end
  end
end
