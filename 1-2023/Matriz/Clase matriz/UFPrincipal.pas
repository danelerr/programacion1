...
type
  TfrmPrincipal = class(TForm)
    ...
    Existepal1: TMenuItem;
    Llenarens1: TMenuItem;
    Interseccionelementoscol1: TMenuItem;
    ...
    procedure Existepal1Click(Sender: TObject);
    procedure Llenarens1Click(Sender: TObject);
    procedure Interseccionelementoscol1Click(Sender: TObject);
  private
...
procedure TfrmPrincipal.Existepal1Click(Sender: TObject);
var s: string;
begin
  s := inputBox('Que palabra busca', '', '');
  if   M.existePal(s) then ShowMessage('Si esta')
  else ShowMessage('No esta');
end;
...
procedure TfrmPrincipal.Interseccionelementoscol1Click(Sender: TObject);
begin
  ShowMessage(M.interseccionDigColumna);
end;

procedure TfrmPrincipal.Llenarens1Click(Sender: TObject);
begin
   M.Redimensionar(SGMatriz.RowCount,SGMatriz.ColCount);
    M.llenarEnFormaSDiagonal;
end;
