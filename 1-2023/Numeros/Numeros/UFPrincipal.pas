...
type
  TfrmPrincipal = class(TForm)
    ...
    procedure Separcen1Click(Sender: TObject);
  private
...
procedure TfrmPrincipal.Separcen1Click(Sender: TObject);
var num: cardinal;
begin
  num := StrToInt( inputBox('Ingrese un numero', 'Numero', ''));
  if N.seParecen(num) then  Label2.Caption:='Se parecen'
  else Label2.Caption := 'No se parece';
