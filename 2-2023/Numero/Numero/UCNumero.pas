...
begin
  ...
  while (i < countDigit) do begin
    ...
    while n>0 do begin
      ...
      n := n div 10;
      if (d <> 0) then begin
        if (d + sumDig <= k) then begin
          sumDig := sumDig + d;
          num := num *10 + d;
        end;
        if ((d + (sumDig - num mod 10)) > sumDig) and ((d + sumDig - num mod 10) <= k) then begin
          sumDig := d + (sumDig - num mod 10);
          num := num div 10;
          num := num *10 + d;
        end;
      end;
