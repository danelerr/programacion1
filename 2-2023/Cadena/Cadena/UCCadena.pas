...
Type
    Cadena = class
      ...
      Public
        ...
        //elimina la palabra del i-esima palabra
        //Ej: palabra 1234  arbol   lapiz
        //delWord(3) -> eliminara "arbol", porque es la 3er palabra
        procedure delWord(p: word);

        //devuelve la i-esima palabra
        //Ej: palabra 1234  arbol   lapiz
        //nWord(2) -> devuelve "1234", porque es la 2da palabra
