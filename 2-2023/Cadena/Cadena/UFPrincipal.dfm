object Form1: TForm1
  ...
  object MainMenu1: TMainMenu
    ...
    object Cadena1: TMenuItem
      Caption = 'Cadena'
      object Cadena2: TMenuItem
        Caption = 'Cargar cadena'
        OnClick = Cadena2Click
      end
      ...
      object Mayuscula1: TMenuItem
        Caption = 'Mayuscula'
        OnClick = Mayuscula1Click
      end
      object oentero1: TMenuItem
        Caption = 'To entero'
        OnClick = oentero1Click
      end
      object Cantidaddepalabras1: TMenuItem
        Caption = 'Cantidad de palabras'
        OnClick = Cantidaddepalabras1Click
      end
      object Operarcadean1: TMenuItem
        Caption = 'Operar cadena'
        OnClick = Operarcadean1Click
      end
      object delword1: TMenuItem
        Caption = 'del word'
        OnClick = delword1Click
      end
    end
  end
end
