...
begin
  V.AddElemnt(StrtoFloat(InputBox('','Elemento a añadir','')));
end;
...
begin
  v.DelElement(StrToInt(InputBox('','Posición','')));
end;
...
begin
  V.InsElement(StrToInt(InputBox('','Posición','')),StrToFloat(InputBox('','Elemento','')));
end;
...
begin
  V.ModElement(StrToInt(InputBox('','Posición','')),StrToFloat(InputBox('','Elemento','')));
end;
...
begin
  showmessage(FloatToStr(V.GetElement(StrToInt(InputBox('Posición','Nro','')))))
end;
